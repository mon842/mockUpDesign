        ...
        <div className='p-4'>
            <div className='relative flex mt-10 md:mt-3 lg:mt-5 mx-6 mb-7 '>
                ...
                <div className='mx-2 mt-2'>
                    <div className={`font-bold text-lg ${robo.className}`}>Hi Mike,</div>
            ...
            <div className='mx-6'>
                <p className={`font-semibold text-base mb-2 ${robo.className}`}>Today</p>
                <p className={`font-bold text-3xl ${robo.className}`}>$19.45</p>
                <p className='text-gray-400 text-xs'>Account balance</p>

                <div className='grid grid-cols-2 md:grid-cols-2 lg:grid-cols-1 mt-4' >
                    <div className='mb-2'>
                        <p className={`font-bold text-xl ${robo.className}`}>$4,000</p>
                        <p className='text-gray-400 text-xs'>Year-to-Date</p>
                    </div>

                    <div className='mb-2'>
                        <p className={`font-bold text-xl ${robo.className}`}>$1,892</p>
            ...
            <div className={`mx-6 my-6 font-semibold text-base ${robo.className}`}>Recent Transactions</div>
            <Notes />
            <Notes />
            <Notes />
        </div>
